...
| Area | Owner |
| --- | --- |
| Governance | `policies/00-governance.md` |
| Security and secrets | `policies/01-security-and-secrets.md` |
...
Adapter files may reference these canonical files, but must not duplicate their
full content.
